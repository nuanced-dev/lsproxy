...
use common::api_types::{ErrorResponse, FindIdentifierRequest, FindIdentifierResponse};
use log::{error, info};
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Identifier found successfully", body = FindIdentifierResponse),
