# Ruby Sorbet 3.3.10 LSP server container
# Builds on top of the Ruby 3.3.10 image and adds sorbet gem

ARG LANGUAGE_IMAGE_VERSION="missing-build-arg-LANGUAGE_IMAGE_VERSION"
FROM nuanced-lsp-ruby-3.3.10:${LANGUAGE_IMAGE_VERSION}
